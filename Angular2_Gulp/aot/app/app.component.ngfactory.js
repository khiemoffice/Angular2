...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_1 = this.renderer.createText(this._el_0, 'My First Angular App frerf', null);
        this.init([], [
            this._el_0,
            this._text_1
        ], [], []);
...
function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('c:/Users/User_Drca88/angular2/Angular2_Gulp/app/app.component.ts class AppComponent - inline template', 0, import8.ViewEncapsulation.None, styles_AppComponent, {}));
    }
