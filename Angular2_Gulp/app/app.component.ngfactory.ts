...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_1 = this.renderer.createText(this._el_0,'My First Angular App frerf',(null as any));
    this.init([],[
      this._el_0,
      this._text_1
    ]
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('c:/Users/User_Drca88/angular2/Angular2_Gulp/app/app.component.ts class AppComponent - inline template',0,import8.ViewEncapsulation.None,styles_AppComponent,{})); }
